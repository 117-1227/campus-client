...
const TITLES = { assistantsList: '学助列表', workHoursStats: '工时统计', scheduleMgmt: '排班管理' }
...
export default function TeacherShell({ auth, onLogout, remainMs, formatRemain, expiredModal }) {
  ...
  const renderPage = () => { switch (currentPage) { case 'assistantsList': return <AssistantsList />; case 'workHoursStats': return <WorkHoursStats />; case 'scheduleMgmt': return <ScheduleManagement />; default: return <AssistantsList /> } }
