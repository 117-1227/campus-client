...
export default function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm bg-white rounded-xl border border-gray-200 shadow-sm p-6 relative">
        <button onClick={() => setShowSettings(true)} className="absolute top-3 right-3 p-2 text-gray-300 hover:text-gray-500 hover:bg-gray-100 rounded-lg transition-colors" title="服务器设置">
